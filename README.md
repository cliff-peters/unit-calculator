...
Unit Calc takes the guesswork out of the 8-minute rule. Whether you are calculating units for a single session or breaking down a multi-intervention treatment, the tool gives you billable units, shows how close you are to the next unit, and provides a full reference table.
...
- Billable unit calculation with color-coded results
- Minutes to next unit indicator with progress bar
- Visual proximity alerts when you are close to the next unit threshold
- Full 8-minute rule reference table with current unit highlighted
...
2. Choose Multi-Intervention or Total Minutes
3. Enter your timed minutes
